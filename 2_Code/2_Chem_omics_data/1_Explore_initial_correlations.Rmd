...
for (col in columns) {
  ...
  p <- ggplot(data, aes(x = .data[[col]], y = Injury_Protein)) +
    ...
    labs(x = paste0('log[', col, ']'), y = "Total Protein (TP) (mg/mL)") +
...
pdf("C:\\Users\\Jessie PC\\OneDrive - University of North Carolina at Chapel Hill\\Symbolic_regression_github\\NIH_Cloud_NOSI\\5_Plots\\2_Chemical_measurements\\Data_distributions\\scatter_plots.pdf", width = 11, height = 8.5)
