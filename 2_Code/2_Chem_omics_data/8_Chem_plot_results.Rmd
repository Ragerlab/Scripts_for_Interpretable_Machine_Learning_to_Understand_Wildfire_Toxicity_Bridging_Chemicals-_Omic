...
# Set working directory to project root (two levels up from this Rmd file)
...
print(p)
# Save
plot_filename <- '../../5_Plots/2_Chemical_measurements/pysr/Prediction_spread_all.png'
...
plot_filename <- '../../5_Plots/2_Chemical_measurements/pysr/Prediction_vs_actual_all.png'
...
p_bar_two <- ggplot(test_df, aes(x = test_df$rownames, y = Dif, fill = Group)) +
  ...
  scale_fill_manual(values = custom_colors)
# Save the plot
plot_filename_scatter <- '../../5_Plots/2_Chemical_measurements/pysr/Actual_vs_Predicted_difference.png'
...
```{r}
# Load in data
sens_full <- read.csv('../../4_Model_results/2_Chemical_measurements/pysr/pysr_RMSE_sensitivity_Full.csv')
sens_pca <- read.csv('../../4_Model_results/2_Chemical_measurements/pysr/pysr_RMSE_sensitivity_PCA.csv')
sens_elastic <- read.csv('../../4_Model_results/2_Chemical_measurements/pysr/pysr_RMSE_sensitivity_elastic.csv')
...
p <- ggplot(dat_all, aes(x = Iteration, y = log(RMSE), color = Complexity)) +
  ...
  # Save
  plot_filename <- '../../5_Plots/2_Chemical_measurements/pysr/sensitivity.png'
  ggsave(plot_filename, p, width = 8, height = 4)
...
# Save
plot_filename <- '../../5_Plots/2_Chemical_measurements/rf/variable_importance_all.png'
ggsave(plot_filename, p, width = 4, height = 4)
```
...
# Save
plot_filename <- '../../5_Plots/2_Chemical_measurements/xgb/variable_importance_all.png'
ggsave(plot_filename, p, width = 4, height = 4)
```
