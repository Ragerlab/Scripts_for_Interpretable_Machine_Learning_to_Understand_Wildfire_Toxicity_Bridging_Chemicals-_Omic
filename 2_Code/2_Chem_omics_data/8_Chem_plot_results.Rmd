...
# RF importance
```{r}
dat_full <- read.csv('..\\..\\3_Data_intermediates\\2_Chemical_measurements\\rf\\rf_var_importance_Full.csv')
dat_pca <- read.csv('..\\..\\3_Data_intermediates\\2_Chemical_measurements\\rf\\rf_var_importance_PCA.csv')
dat_elastic <- read.csv('..\\..\\3_Data_intermediates\\2_Chemical_measurements\\rf\\rf_var_importance_Elastic.csv')
...
# Save
plot_filename <- paste0('C:/Users/jrchapp3/OneDrive - University of North Carolina at Chapel Hill/Symbolic_regression_github/NIH_Cloud_NOSI/5_Plots/2_Chemical_measurements/xgb/variable_importance_all.png')
ggsave(plot_filename, p, width = 4, height = 4)
```
