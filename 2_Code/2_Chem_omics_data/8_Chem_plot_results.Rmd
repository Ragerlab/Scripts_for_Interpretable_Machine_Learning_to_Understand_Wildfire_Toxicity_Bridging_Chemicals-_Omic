...
# Save
plot_filename <- paste0('..\\..\\5_Plots/2_Chemical_measurements/pysr/variable_importance_all.png')
#ggsave(plot_filename, p, width = 7, height = 4)
```
...
for(i in 1:length(dat_all_list)){
  ...
  pdf(paste0("C:/Users/jrchapp3/OneDrive - University of North Carolina at Chapel Hill/Symbolic_regression_github/NIH_Cloud_NOSI/5_Plots/2_Chemical_measurements/pysr/variable_importance_distribution_", names(dat_all_list)[i], ".pdf"))
...
# RF importance
```{r}
dat_full <- read.csv('C:\\Users\\jrchapp3\\OneDrive - University of North Carolina at Chapel Hill\\Symbolic_regression_github\\NIH_Cloud_NOSI\\4_Model_results\\2_Chemical_measurements\\rf\\rf_var_importance_Full.csv')
dat_pca <- read.csv('C:\\Users\\jrchapp3\\OneDrive - University of North Carolina at Chapel Hill\\Symbolic_regression_github\\NIH_Cloud_NOSI\\4_Model_results\\2_Chemical_measurements\\rf\\rf_var_importance_PCA.csv')
dat_elastic <- read.csv('C:\\Users\\jrchapp3\\OneDrive - University of North Carolina at Chapel Hill\\Symbolic_regression_github\\NIH_Cloud_NOSI\\4_Model_results\\2_Chemical_measurements\\rf\\rf_var_importance_Elastic.csv')
