...
# ggsave('C:/Users/jrchapp3/OneDrive - University of North Carolina at Chapel Hill/Symbolic_regression_github/NIH_Cloud_NOSI/images/4_ChemOmics_measurements/prediction_spread.png',p, width = 7, height = 4)
...
plot_filename <- paste0('C:/Users/jrchapp3/OneDrive - University of North Carolina at Chapel Hill/Symbolic_regression_github/NIH_Cloud_NOSI/5_Plots/4_ChemOmics_measurements/Prediction_vs_actual_all.png')
...
p_bar_two <- ggplot(test_df, aes(x = test_df$rownames, y = Dif, fill = Group)) +
  ...
  guides(fill = guide_legend(nrow = 3, byrow = TRUE))  # Adjust legend to have three rows
# Save the plot
plot_filename_scatter <- paste0('C:/Users/jrchapp3/OneDrive - University of North Carolina at Chapel Hill/Symbolic_regression_github/NIH_Cloud_NOSI/images/4_ChemOmics_measurements/Actual_vs_Predicted_difference.png')
...
```{r}
# Load in data
dat <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\pysr_RMSE_sensitivity.csv')
...
# Save
plot_filename <- paste0('C:/Users/jrchapp3/OneDrive - University of North Carolina at Chapel Hill/Symbolic_regression_github/NIH_Cloud_NOSI/images/4_ChemOmics_measurements/sensitivity.png')
  ggsave(plot_filename, p, width = 4, height = 4)
```

# Plot pathways
```{r}
top_diseases <- read.table('C://Users//jrchapp3//OneDrive - University of North Carolina at Chapel Hill//Symbolic_regression_github//NIH_Cloud_NOSI//Data_inputs//4_ChemOmics_measurements//top_diseases.txt', header = TRUE, sep = "\t", stringsAsFactors = FALSE)
...
top_pathways <- read.table(
  'C://Users//jrchapp3//OneDrive - University of North Carolina at Chapel Hill//Symbolic_regression_github//NIH_Cloud_NOSI//Data_inputs//4_ChemOmics_measurements//top_pathways.txt',
...
dat_DEG <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\pysr\\variable_importance_DEG.csv')
dat_pca <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\pysr\\variable_importance_PCA.csv')
dat_elastic <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\pysr\\variable_importance_Elastic.csv')
...
dat_all_DEG <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\pysr\\partial_deriv_DEG.csv')
dat_all_pca <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\pysr\\partial_deriv_PCA.csv')
dat_all_elastic <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\pysr\\partial_deriv_Elastic.csv')
...
# read in gene names
degs <- read.csv('..\\..\\1_Data_inputs\\4_ChemOmics_measurements\\DEGs.csv') %>%
  .[,4:5]
genes <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\all_genes_in_hof.csv') 
```
...
genes_clean <- left_join(genes, degs_clean) %>%
  select(Gene_Symbol) %>%
  unique()
#write.csv(genes_clean, file = '..\\..\\4_Model_results\\4_ChemOmics_measurements\\all_genes_in_hof_clean.csv' )
```
...
# # Save
plot_filename <- paste0('..\\..\\5_Plots\\4_ChemOmics_measurements/variable_importance_all.png')
...
# Save
plot_filename <- paste0('..\\..\\5_Plots/4_ChemOmics_measurements/pysr/RMSE_by_HOF.png')
ggsave(plot_filename, p, width = 4, height = 4)
```

# RF importance
```{r}
dat <- read.csv('..\\..\\4_Model_results\\4_ChemOmics_measurements\\rf\\rf_var_importance.csv')
...
p <- ggplot(dat_full, aes(x = reorder(Feature, -Importance), y = Importance)) +
  ...
  scale_y_continuous(expand = c(0, 0)) 
# Save
plot_filename <- paste0('C:/Users/jrchapp3/OneDrive - University of North Carolina at Chapel Hill/Symbolic_regression_github/NIH_Cloud_NOSI/images/4_ChemOmics_measurements/rf/variable_importance_all.png')
ggsave(plot_filename, p, width = 4, height = 4)
```
