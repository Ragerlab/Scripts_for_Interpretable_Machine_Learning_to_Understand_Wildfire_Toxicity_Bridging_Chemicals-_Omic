...
for i in range(len(operators.index)):
    ...
    for j in range(len(sim_dict)):
        ...
        # Save to csv
        file_name = f'4_Model_results/1_Simulated_data/feyn/{list(operators.index)[i]}_{list(sim_dict.keys())[j]}_HOF.csv'
...
# Save to csv
results_df
file_name = f'4_Model_results/1_Simulated_data/feyn/results.csv'
