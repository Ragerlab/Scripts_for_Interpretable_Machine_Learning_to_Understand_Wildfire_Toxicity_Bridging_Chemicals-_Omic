...
# -------------------------------------------------------------------
# Numerical integration over all variables using nquad
# -------------------------------------------------------------------
...
# Filters to equations with loss < 17 to exclude poorly fitting models
# -------------------------------------------------------------------
...
for operator_level in subdirectories:
    ...
    for dataset_key in sim_dict.keys():
        ...
        for chem in chems_in_results:
            ...
            # Skip variables with no range (constant across all samples)
            if range_value == 0:
