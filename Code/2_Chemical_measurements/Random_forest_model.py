...
# PCA
train_x_pca = pd.read_pickle("Data_inputs/train_x_pca")
test_x_pca = pd.read_pickle("Data_inputs/test_x_pca")

# LASSO
train_x_lasso = pd.read_pickle("Data_inputs/train_x_lasso")
test_x_lasso= pd.read_pickle("Data_inputs/test_x_lasso")
...
with open('Data_inputs/train_input_dict.pkl', 'wb') as f:
    pickle.dump(train_input_dict, f)
with open('Data_inputs/test_input_dict.pkl', 'wb') as f:
